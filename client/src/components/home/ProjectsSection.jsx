...
const ProjectsSection = () => {
  ...
  const MAX_DESCRIPTION_LENGTH = 110; // Adjust this value as needed
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
            Check out some of the awesome work I have done. I have worked on a variety of projects, from web applications to mobile apps, and I am always looking for new challenges and opportunities to learn.
          </p>
        </div>
            ...
            <div key={project._id} className="p-4 lg:w-1/2 ">
              <Link to={`/projects/${project._id}`} className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left project-sec-card">
                ...
                <div className="flex-grow sm:pl-8">
                  ...
                  <p className="mb-4">
                    {project.description && project.description.length > MAX_DESCRIPTION_LENGTH
